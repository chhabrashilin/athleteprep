...
const ROADMAP_MODULES: { name: string; description: string; status: CricketModuleStatus; href?: string }[] = [
  ...
  { name: "Points Table",             description: "Live standings with NRR, wins, losses, and points.",                  status: "available",        href: "/cricket/leagues" },
  { name: "Leaderboards",             description: "Top batsmen, top bowlers, and all-time records.",                     status: "available",        href: "/cricket/leagues" },
  { name: "Team Statistics",          description: "Team-level run rates, win/loss records, and NRR breakdown.",           status: "available",        href: "/cricket/leagues" },
  { name: "Player Statistics",        description: "Per-player batting, bowling, and fielding career stats.",              status: "available",        href: "/cricket/players" },
  { name: "Worm Chart",               description: "Cumulative runs progression across both innings.",                   status: "available",        href: "/cricket/leagues" },
  { name: "Manhattan Chart",          description: "Runs-per-over bar chart with wicket indicators.",                     status: "available",        href: "/cricket/leagues" },
  { name: "Run Rate Graph",           description: "Current vs required run rate trend line for each innings.",           status: "available",        href: "/cricket/leagues" },
  { name: "Wagon Wheel",              description: "Shot-zone breakdown. Full shot map requires zone data during scoring.", status: "available",       href: "/cricket/leagues" },
  { name: "Partnership Analysis",     description: "Partnership bars, run rates, and fall-of-wicket summary.",            status: "available",        href: "/cricket/leagues" },
  { name: "Match Momentum",           description: "Experimental over-by-over momentum model.",                           status: "available",        href: "/cricket/leagues" },
  { name: "Video Streaming Foundation", description: "Overlay-only streaming: OBS/vMix browser-source overlays with live score data.", status: "available", href: "/cricket/leagues" },
